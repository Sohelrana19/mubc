    ...
    <div class="col-sm-12">
        <div class="iq-card">
              <div class="iq-card-header d-flex justify-content-between">
                 ...
                 <h4 class="card-title">Exam Schedule Class <span>{{$clasid->classNameEnglish}}</span> </h4>
                 </div>
              </div>
                       ...
                       <tr>
                          ...
                          <td>
                             <div class="flex align-items-center list-user-action">
                                <a data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="{{ url('editSubject', $User->SubId)}}"><i class="ri-pencil-line"></i></a>
                                <a id="delete" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="{{ url('deletSubject', $User->SubId)}}"><i class="ri-delete-bin-line"></i></a>
                             </div>
                          </td>
                       </tr>
